          ...
          <div className={`relative rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-12 shadow-2xl shadow-indigo-500/20 overflow-hidden h-full ${t.cardBg}`}>
            ...
            <div className="relative z-10">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Link
                  href="/register"
                  className="block w-full py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-2xl bg-indigo-500 text-white hover:bg-indigo-400 transition-colors text-center mb-6 sm:mb-10 shadow-[0_0_30px_rgba(99,102,241,0.3)]"
                >
              ...
              <div className="space-y-3 sm:space-y-5">
                {features.map((feature, i) => (
                  <motion.div
                    ...
                    key={i}
                    className={`flex items-center gap-3 sm:gap-4 ${t.textSecondary}`}
                  >
