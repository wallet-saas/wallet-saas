          ...
          <div className={`rounded-[2.5rem] p-8 lg:p-12 relative shadow-2xl shadow-indigo-500/20 overflow-hidden h-full`} style={{ backgroundColor: t.pageBg.includes('bg-white') ? '#ffffff' : '#0A0A0F' }}>
            ...
            <div className="relative z-10">
              ...
              >
                <Link
                  href="/register"
                  className="block w-full py-4 text-lg font-semibold rounded-2xl bg-white text-black hover:bg-slate-200 transition-colors mb-10 shadow-[0_0_30px_rgba(255,255,255,0.2)] text-center"
                >
