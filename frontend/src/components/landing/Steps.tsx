        ...
        >
          ...
          {steps.map((step, i) => (
            <motion.div key={i} variants={item} className="relative flex flex-col items-center text-center group">
              <div className="w-16 h-16 rounded-2xl bg-black/40 backdrop-blur-sm border border-indigo-500/30 flex items-center justify-center text-2xl font-bold text-indigo-400 mb-8 shadow-xl shadow-indigo-500/10 group-hover:scale-110 group-hover:bg-indigo-500/10 group-hover:border-indigo-400 transition-all duration-300 z-10">
                {step.number}
              </div>
